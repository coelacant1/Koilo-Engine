...
public:
    ...
    static void TestAdd();
    static void TestAdditiveInverse();
    static void TestConjugate();
    static void TestDefaultConstructor();
    static void TestDeltaRotation();
    static void TestDivide();
    static void TestDotProduct();
    static void TestEdgeCases();
    static void TestGetBiVector();
    ...
    static void TestIsNonZero();
    static void TestMagnitude();
    static void TestMultiplicativeInverse();
    static void TestMultiply();
    static void TestNormal();
    static void TestParameterizedConstructor();
    static void TestPermutate();
    static void TestPower();
    static void TestRotateVectorUnit();
    static void TestSubtract();
    static void TestToString();
    static void TestUnitQuaternion();
