...
//    static void TestQuaternionFromDirectionVectors(); ///< Tests the creation of a quaternion from direction vectors (commented out).
    ...
    static void TestGetAxisAngle();
    static void TestGetDirectionAngle();
    static void TestGetEulerAngles();
    static void TestGetQuaternion();
    static void TestGetRotationMatrix();
    static void TestGetYawPitchRoll();
