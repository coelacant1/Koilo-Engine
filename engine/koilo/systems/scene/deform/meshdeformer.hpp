 ...
 *
 * The `MeshDeformer` class allows for various deformations, including perspective,
...
public:
    /**
     * @brief Constructs an `MeshDeformer` for a single object.
     *
     * @param object Pointer to the `Mesh` to be deformed.
     */
    MeshDeformer(Mesh* object);

    /**
     * @brief Constructs an `MeshDeformer` for multiple objects.
     *
